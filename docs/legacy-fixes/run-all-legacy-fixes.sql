-- =============================================================================
-- Apply2Campus – Sunucuda tek seferde çalıştırılacak tüm SQL düzeltmeleri
-- Veri silmeden eksik tabloları oluşturur, mevcut tabloları günceller.
--
-- Kullanım:
...
\echo '1/3 Eksik tablolar (Announcement, Institution, ConsultantSlot, Task vb.)...'
...
\echo '2/3 OfferItem güncellemesi (teklif gönderme 500 hatası düzeltmesi)...'

-- OfferItem: durationWeeks nullable, institutionId/startDate/endDate ekle
...
\echo '3/3 UserNotification tablosu (bildirimler)...'
